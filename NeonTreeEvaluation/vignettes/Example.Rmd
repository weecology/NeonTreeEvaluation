---
title: "Example Predictions and sample lidR Evaluation"
...
rgb<-stack(system.file("extdata","SJER_052.tif",package="NeonTreeEvaluation"))

#Path to dataset
xmls<-xml_parse(system.file("extdata","SJER_052.xml",package="NeonTreeEvaluation"))
...
```{r}
point_cloud<-readLAS(system.file("extdata","SJER_052.laz",package="NeonTreeEvaluation"))
```
